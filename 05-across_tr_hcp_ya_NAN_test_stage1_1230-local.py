...
parser.add_argument('--dataroot', type=str, default='/data/hzb/project/BodyDecoding/data/HCP_NAN_test_pcp/Schaefer/filt_noglobal', help='root directory of the dataset')
...
parser.add_argument('--phenoroot', type=str, default='/data/hzb/project/BodyDecoding/data/HCP_NAN_test_pcp/HCP_Phenotype')
...
################## Define Dataloader ##################################
train_dataset, val_dataset, test_dataset, text_feature = data_load_hcp_nan_test_fmri(path, name, opt)
...
for epoch in range(0,stage1_epoch):
    ...
    # model_filename = f'./model/stage1_across_tr_hcp_ya_model_{epoch}.pth'
    # dataset_filename =  f'./model/stage1_across_tr_hcp_ya_dataset_{epoch}.pt'
    ...
    # write_epoch_acc_to_file(epoch, val_acc, file_path='./model/stage1_across_tr_hcp_ya_epoch_acc.txt')
...
#
# df = pd.read_csv('./model/stage1_across_tr_hcp_ya_epoch_acc.txt', sep=r'[,\s]+')
...
#         continue
#     model_filename = f'./model/stage1_across_tr_hcp_ya_model_{all_epoch_epoch[i]}.pth'
#     dataset_filename =  f'./model/stage1_across_tr_hcp_ya_dataset_{all_epoch_epoch[i]}.pt'
#
...
#
# model_filename = f'./model/stage1_across_tr_hcp_ya_model_0.pth'
# dataset_filename =  f'./model/stage1_across_tr_hcp_ya_dataset_0.pt'
#
# if os.path.exists(model_filename):
#     os.remove(model_filename)
# if os.path.exists(dataset_filename):
