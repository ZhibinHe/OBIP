...
parser.add_argument('--dataroot', type=str, default='/data/hzb/project/BodyDecoding_data/ABCD_HCP_A_HCP_YA_pcp/Schaefer/filt_noglobal', help='root directory of the dataset')
...
parser.add_argument('--phenoroot', type=str, default='/data/hzb/project/BodyDecoding_data/ABCD_HCP_A_HCP_YA_pcp/ABCD_HCP_A_HCP_YA_Phenotype')
parser.add_argument('--stage1_epochs', type=int, default=50, help='number of epochs of training')  #52
...
################## Define Dataloader ##################################
train_dataset, val_dataset, test_dataset, text_feature = data_load_abcd_hcp_a_hcp_ya_fmri(path, name, opt)
...
model1 = CombinedModel_sink_feature400().to(device)     # ABCD 115  abcd_hcpd_hcpya 184
...
for epoch in range(0,stage1_epoch):
    ...
    if epoch==21:
        ...
        model_filename = f'./model/stage1_across_tr_abcd_hcp_a_hcp_ya_model_{epoch}.pth'
        dataset_filename =  f'./model/stage1_across_tr_abcd_hcp_a_hcp_ya_dataset_{epoch}.pt'
    ...
    # write_epoch_acc_to_file(epoch, val_acc, file_path='./model/stage1_across_tr_abcd_hcp_a_hcp_ya_epoch_acc.txt')
...
# df = pd.read_csv('./model/stage1_across_tr_abcd_hcp_a_hcp_ya_epoch_acc.txt', sep=r'[,\s]+')
...
#         continue
#     model_filename = f'./model/stage1_across_tr_abcd_hcp_a_hcp_ya_model_{all_epoch_epoch[i]}.pth'
#     dataset_filename =  f'./model/stage1_across_tr_abcd_hcp_a_hcp_ya_dataset_{all_epoch_epoch[i]}.pt'
#
...
#
# model_filename = f'./model/stage1_across_tr_abcd_hcp_a_hcp_ya_model_0.pth'
# dataset_filename =  f'./model/stage1_across_tr_abcd_hcp_a_hcp_ya_dataset_0.pt'
#
# if os.path.exists(model_filename):
#     os.remove(model_filename)
# if os.path.exists(dataset_filename):
