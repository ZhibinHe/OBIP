...
parser.add_argument('--test_dataset', type=str, default='HCP_A')
...
################## Define Dataloader ##################################
train_dataset, val_dataset, test_dataset, text_feature = data_load_abcd_fmri_delete_high(path, name, opt)
