...
#################################
model1 = torch.load('./model/stage1_across_tr_abcd_hcp_a_hcp_ya_model_21.pth')
train_loader, val_loader,text_feature, text_feature_zero, fusion_feature_tr, fusion_feature_val, label_score_tr, label_score_val, regress_weight_tr, regress_weight_val = torch.load('./model/stage1_across_tr_abcd_hcp_a_hcp_ya_dataset_21.pt')
...
#second
hcp_feature, hcp_label = torch.load('./model/stage2_across_te_hcpd_feature_label_0108.pt')
...
for epoch in range(stage1_epoch, 300):
    ...
    filename111 = f'./log/tr_abcd_hcp_a_hcp_ya_te_hcp_d/label_sys_corr_epoch_{epoch}.npy'
    np.save(filename111, label_sys_corr)

    filename111 = f'./log/tr_abcd_hcp_a_hcp_ya_te_hcp_d/sys_score_epoch_{epoch}.npy'
    np.save(filename111, sys_score)

    filename111 = f'./log/tr_abcd_hcp_a_hcp_ya_te_hcp_d/label_score_epoch_{epoch}.npy'
