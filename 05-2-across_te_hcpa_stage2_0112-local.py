...
parser.add_argument('--dataroot', type=str, default='/data/hzb/project/BodyDecoding_data/ABCD_HCP_D_HCP_YA_pcp/Schaefer/filt_noglobal', help='root directory of the dataset')
...
parser.add_argument('--phenoroot', type=str, default='/data/hzb/project/BodyDecoding_data/ABCD_HCP_D_HCP_YA_pcp/ABCD_HCP_D_HCP_YA_Phenotype')
...
parser.add_argument('--num_prediction', type=int, default=184, help='number prediction')
...
#################################
model1 = torch.load('./model/stage1_across_tr_abcd_hcp_d_hcp_ya_model_5.pth')
train_loader, val_loader,text_feature, text_feature_zero, fusion_feature_tr, fusion_feature_val, label_score_tr, label_score_val, regress_weight_tr, regress_weight_val = torch.load('./model/stage1_across_tr_abcd_hcp_d_hcp_ya_dataset_5.pt')
...
#second
hcp_feature, hcp_label = torch.load('./model/stage2_across_te_hcpa_feature_label_0106.pt')
...
##training dataset
train_dataset, val_dataset, test_dataset, text_feature = data_load_abcd_hcp_d_hcp_ya_fmri(path, name, opt)
...
for epoch in range(stage1_epoch, 300):
    ...
    # filename111 = f'./log/tr_abcd_hcp_d_hcp_ya_te_hcp_a/label_sys_corr_epoch_{epoch}.npy'
    # np.save(filename111, label_sys_corr)
    #
    # filename111 = f'./log/tr_abcd_hcp_d_hcp_ya_te_hcp_a/sys_score_epoch_{epoch}.npy'
    # np.save(filename111, sys_score)
    #
    # filename111 = f'./log/tr_abcd_hcp_d_hcp_ya_te_hcp_a/label_score_epoch_{epoch}.npy'
