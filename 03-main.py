...
parser.add_argument('--dataroot', type=str, default='/data/hzb/project/Brain_Predict_Score/BrainGNN/BrainGNN_Pytorch-main/data/ABIDE_pcp/cpac/filt_noglobal', help='root directory of the dataset')
