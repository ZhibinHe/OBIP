...
data_folder_orig = '/data/hzb/project/BodyDecoding_data/ABCD/'
data_folder = '/data/hzb/project/BodyDecoding/data/ABCD_pcp/Schaefer/filt_noglobal/'

if not os.path.exists(data_folder):
    os.makedirs(data_folder)
shutil.copyfile(os.path.join(data_folder_orig,'ABCD_subject_id/Subject_ID.txt'), os.path.join(data_folder, 'subject_IDs.txt'))
...
def main():
    ...
    subject_IDs = Reader.get_ids_abcd() #changed path to data path
