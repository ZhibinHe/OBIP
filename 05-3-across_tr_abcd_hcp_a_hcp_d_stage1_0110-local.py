...
parser.add_argument('--dataroot', type=str, default='/data/hzb/project/BodyDecoding_data/ABCD_HCP_A_HCP_D_pcp/Schaefer/filt_noglobal', help='root directory of the dataset')
...
parser.add_argument('--phenoroot', type=str, default='/data/hzb/project/BodyDecoding_data/ABCD_HCP_A_HCP_D_pcp/ABCD_HCP_A_HCP_D_Phenotype')
...
################## Define Dataloader ##################################
train_dataset, val_dataset, test_dataset, text_feature = data_load_abcd_hcp_a_hcp_d_fmri(path, name, opt)
...
for epoch in range(0,stage1_epoch):
    ...
    if epoch==11:
        ...
        model_filename = f'./model/stage1_across_tr_abcd_hcp_a_hcp_d_model_{epoch}.pth'
        dataset_filename =  f'./model/stage1_across_tr_abcd_hcp_a_hcp_d_dataset_{epoch}.pt'
    ...
    # write_epoch_acc_to_file(epoch, val_acc, file_path='./model/stage1_across_tr_abcd_hcp_a_hcp_d_epoch_acc.txt')
...
#
#
# df = pd.read_csv('./model/stage1_across_tr_abcd_hcp_a_hcp_d_epoch_acc.txt', sep=r'[,\s]+')
...
#         continue
#     model_filename = f'./model/stage1_across_tr_abcd_hcp_a_hcp_d_model_{all_epoch_epoch[i]}.pth'
#     dataset_filename =  f'./model/stage1_across_tr_abcd_hcp_a_hcp_d_dataset_{all_epoch_epoch[i]}.pt'
#
...
#
# model_filename = f'./model/stage1_across_tr_abcd_hcp_a_hcp_d_model_0.pth'
# dataset_filename =  f'./model/stage1_across_tr_abcd_hcp_a_hcp_d_dataset_0.pt'
#
# if os.path.exists(model_filename):
#     os.remove(model_filename)
# if os.path.exists(dataset_filename):
