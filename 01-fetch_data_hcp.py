...
data_folder_orig = '/data/hzb/project/BodyDecoding_data/HCP/'
data_folder = '/data/hzb/project/BodyDecoding/data/HCP_pcp/Schaefer/filt_noglobal/'

if not os.path.exists(data_folder):
    os.makedirs(data_folder)
shutil.copyfile(os.path.join(data_folder_orig,'HCP_subject_id/Subject_ID.txt'), os.path.join(data_folder, 'subject_IDs.txt'))
