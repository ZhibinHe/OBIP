...
data_folder_orig = '/data/hzb/project/BodyDecoding_data/HCP_A/'
data_folder = '/data/hzb/project/BodyDecoding/data/HCP_A_pcp/Schaefer/filt_noglobal/'

if not os.path.exists(data_folder):
    os.makedirs(data_folder)
shutil.copyfile(os.path.join(data_folder_orig,'HCP_A_subjetc_id/Subject_ID.txt'), os.path.join(data_folder, 'subject_IDs.txt'))
...
def main():
    ...
    subject_IDs = Reader.get_ids_hcp_a() #changed path to data path
