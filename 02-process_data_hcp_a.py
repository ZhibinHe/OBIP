...
# Process boolean command line arguments       make .h5
def str2bool(v):
...
def main():
    ...
    subject_IDs = Reader.get_ids_hcp_a()
    labels = Reader.get_subject_score_hcp_a(subject_IDs, score='interview_age')
    ...
    for i in range(num_subjects):
        y_data[i, (labels[subject_IDs[i]]) - 1] = 1
