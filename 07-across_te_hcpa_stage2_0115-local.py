...
#################################
model1 = torch.load('./model/delete_descrip_high/HCP_A/stage1_across_tr_abcd_p40_model_3.pth')
train_loader, val_loader,text_feature, text_feature_zero, fusion_feature_tr, fusion_feature_val, label_score_tr, label_score_val, regress_weight_tr, regress_weight_val = torch.load('./model/delete_descrip_high/HCP_A/stage1_across_tr_abcd_p40_dataset_3.pt')
...
for epoch in range(stage1_epoch, 300):
    ...
    filename111 = f'./log/delete_descrip_high/HCP_A/p40/label_sys_corr_epoch_{epoch}.npy'
    np.save(filename111, label_sys_corr)

    filename111 = f'./log/delete_descrip_high/HCP_A/p40/sys_score_epoch_{epoch}.npy'
    np.save(filename111, sys_score)

    filename111 = f'./log/delete_descrip_high/HCP_A/p40/label_score_epoch_{epoch}.npy'
