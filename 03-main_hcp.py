...
parser.add_argument('--dataroot', type=str, default='/data/hzb/project/Brain_Predict_Score/BrainGNN/BrainGNN_Pytorch-main/data_hcp/HCP_pcp/Gordon/filt_noglobal', help='root directory of the dataset')
...
tr_index,val_index,te_index = train_val_test_split_hcp(fold=fold)
...
model = Network(opt.indim,opt.ratio,opt.nclass, R=333).to(device)
print(model)
